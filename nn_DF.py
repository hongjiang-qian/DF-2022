...
class Network(object):
    ...
    def SGD_EpochAdalr(self, training_data, epochs, mini_batch_size, learning_rate, epi, alpha, monitor_cost=True, seed=True, evaluation_data=None):
        """Mini_batch Stochastic gradient descent with adaptive lr based on Epoch. That is to say 
        the learning rate will change every epoch."""
    ...
    def learning_rate_gradient(self, mini_batch, nabla_b, nabla_w, epi, alpha,):
